...
def evaluate(predictions_reader: PredictionsFileReader,
    ...
    for q_id in tqdm(all_q_ids):
        ...
        # Main metric
        #-predictions ['location of house was at home before and at work afterwards',
        # 'smell of house was stinky before and nicesmelling afterwards']
...
def main():
    ...
    parser.add_argument(
        '--gold-file', '-g',
        default="id_answers.jsonl",
        help='Filename with gold answers',
        required=False)

    parser.add_argument(
        '--prediction-file', '-p',
        default=r"prediction_format_constraint_reward_define_0.1.jsonl", #prediction_format_constraint_reward_define_0.1.jsonl
